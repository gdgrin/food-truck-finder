...
from food_truck_info import get_n_closest_trucks
...
def hello():
    ...
    #     resp = get_n_closest_trucks(lat,lon,5)
    # else:
    #     resp = "Please enter a message in the format <latitude,longitude> (i.e. 37,-140)"
